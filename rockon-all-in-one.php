...
function raio_load_textdomain() {
  load_plugin_textdomain( 'rockon-all-in-one' );
}
add_action( 'plugins_loaded', 'raio_load_textdomain' );	

function raio_create_submenus() {
	require_once( RAIO_PATH . 'inc/raio_setting.php' );
}
add_action( 'raio_loaded', 'raio_create_submenus' );

require_once( RAIO_PATH . 'inc/raio_function.php' );	
	
function raio_add_script_header()
{    
 ...
 function raio_add_script_footer()
{
...
function raio_content($raio_atts) {	
...
add_shortcode( 'rockon_content', 'raio_content' );  // [rockon_content limit=25]

/**
 * breadcrumbs Code
 */

 function raio_breadcrumbs()
{
...
add_shortcode( 'rockon_breadcrumbs', 'raio_breadcrumbs' );

function load_raio_wp_admin_style() {
...
add_action( 'admin_enqueue_scripts', 'load_raio_wp_admin_style' );

//  Add RAIO Styles
	function raio_register_styles() {
	...
	add_action('wp_print_styles', 'raio_register_styles');

//  Add RAIO Script
    function raio_register_script() {
...
add_action('wp_print_scripts', 'raio_register_script');	
	

add_action( 'init', 'raio_init_allfun');
 function raio_init_allfun(){
	
	add_action('wp_head', 'raio_add_script_header');
	add_action('wp_footer', 'raio_add_script_footer');
...
add_action( 'init', 'raio_script_hf');
 function raio_script_hf(){
